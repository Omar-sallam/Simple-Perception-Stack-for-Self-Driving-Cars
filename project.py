...
Original file is located at
    https://colab.research.google.com/drive/187xjjT3_VqOSWFk50EnpoGncS3an52fJ
...
def draw_lines(img, lines, color=[255, 0, 0], thickness=10):
    ...
    cnt = np.array([[left_x1,y1], [right_x1,y1], [right_x2,y2], [left_x2,y2]],dtype=np.int32)
    cv2.fillPoly(img, [cnt] ,color=[0,255,0])
